export enum AppPath {
  ...
  // AI Sales Assistant
  AiSalesAssistant = '/ai-sales',
  AiKnowledgeBase = '/ai-sales/knowledge-base',
  AiCustomerProfile = '/ai-sales/customer-profile/:objectNameSingular/:objectRecordId',
  AiDocumentQA = '/ai-sales/document-qa',
  AiRiskAlerts = '/ai-sales/risk-alerts',

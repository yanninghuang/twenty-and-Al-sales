...
const AiSalesPage = lazy(() =>
  import('~/pages/ai-sales/AiSalesPage').then((module) => ({
    default: module.AiSalesPage,
  })),
);

const AiChatPage = lazy(() =>
  import('~/pages/ai-sales/AiChatPage').then((module) => ({
    default: module.AiChatPage,
  })),
);

const AiKnowledgeBasePage = lazy(() =>
  import('~/pages/ai-sales/AiKnowledgeBasePage').then((module) => ({
    default: module.AiKnowledgeBasePage,
  })),
);
